...
public class Functions<E> {
    ...
    public void printNotebookList(ArrayList<Notebook> list){
        ...
        System.out.println("---------------------------------------------------------------------");
        for (Notebook i:list) {
            /*System.out.println("| "+i.getPrintID()+"  |\t "+i.getName()+"\t|"+" "
                    +i.getPrice()+"TL  | "+
                    i.getBrandName()+"\t| "+
            i.getSSD()+"\t   |"+" "+
                    i.getScreen()+"\t   |"+" "+
            ...
            i.getPrintID(),i.getName(),i.getPrice(),i.getBrandName(),i.getStock(),i.getDiscount(),i.getRAM(),i.getScreen(),i.getSSD());
        }
    }
    public void printPhoneList(ArrayList<Phone> list2){
        ...
        for (Phone i:list2) {
            System.out.printf("| %-2s | %-25s | %-15s | %-15s | %-12s | %-18s | %-6s | %-17s | %-10s | %-15s | %-14s | %-9s | \n",
                    i.getPrintID(),i.getName(),i.getPrice(),i.getBrandName(),i.getStock(),i.getDiscount(),i.getRAM(),i.getScreen(),i.getSSD(),i.getBatteryPower(),i.getColor(),i.getColor());
        }
    }
