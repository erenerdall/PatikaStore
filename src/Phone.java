public class Phone extends Product{
    ...
    public Phone(Integer price, Integer discount, Integer stock, String name, String brandName, Integer RAM, Integer SSD, Integer screen, Integer batteryPower, String color, Integer camera) {
